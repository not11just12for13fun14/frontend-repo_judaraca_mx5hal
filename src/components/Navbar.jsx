...
export default function Navbar() {
  const linkClass = ({ isActive }) => `inline-flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors ${isActive ? 'bg-blue-600 text-white' : 'text-blue-100 hover:text-white hover:bg-white/10'}`
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="flex items-center gap-2">
            ...
            <NavLink to="/reservation" className={`${linkClass({ isActive: false })} bg-blue-600 hover:bg-blue-500 text-white`}>
